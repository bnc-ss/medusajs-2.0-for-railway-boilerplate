...
import { CreateOnboardingDTO, CreatePayoutAccountDTO, CreatePayoutDTO, CreatePayoutReversalDTO, IPayoutProvider, PayoutAccountStatus, PayoutWebhookActionPayload } from "@boxncase/framework";
...
declare class PayoutModuleService extends PayoutModuleService_base {
    ...
    getWebhookActionAndData(input: PayoutWebhookActionPayload): Promise<import("@boxncase/framework").PayoutWebhookActionAndDataResponse>;
}
