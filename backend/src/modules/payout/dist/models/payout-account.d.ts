import { PayoutAccountStatus } from "@boxncase/framework";
export declare const PayoutAccount: import("@medusajs/framework/utils").DmlEntity<import("@medusajs/framework/utils").DMLEntitySchemaBuilder<{
...
//# sourceMappingURL=payout-account.d.ts.map