import { MemberRole } from "@boxncase/framework";
export declare const MemberInvite: import("@medusajs/framework/utils").DmlEntity<import("@medusajs/framework/utils").DMLEntitySchemaBuilder<{
    id: import("@medusajs/framework/utils").PrimaryKeyModifier<string, import("@medusajs/framework/utils").IdProperty>;
    email: import("@medusajs/framework/utils").TextProperty;
    role: import("@medusajs/framework/utils").EnumProperty<typeof MemberRole>;
    seller: import("@medusajs/framework/utils").BelongsTo<() => import("@medusajs/framework/utils").DmlEntity<import("@medusajs/framework/utils").DMLEntitySchemaBuilder<{
        id: import("@medusajs/framework/utils").PrimaryKeyModifier<string, import("@medusajs/framework/utils").IdProperty>;
        store_status: import("@medusajs/framework/utils").EnumProperty<typeof import("@boxncase/framework").StoreStatus>;
