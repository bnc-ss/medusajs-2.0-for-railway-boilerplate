...
import { CONFIGURATION_MODULE } from '@boxncase/configuration'
import { ConfigurationModuleService } from '@boxncase/configuration'
import { CreateConfigurationRuleDTO } from '@boxncase/framework'
